...
export function analyzeAtomGeometry(atom, atoms, bonds) {
...
export function estimateLonePairs(atom, bonds) {
    const data = atomData[atom.symbol];
    if (atom.symbol === "H" || data.metal || data.nobleGas)
        return 0;
